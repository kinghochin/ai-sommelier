...
if not st.session_state.messages:
    st.chat_message("assistant", avatar=MODEL_AVATARS[MODEL_CHOICE]).markdown(
       "👋 Hi! This demo shows how RAG (Retrieval-Augmented Generation) can enhance an LLM's responses. Try asking a question before and after providing relevant information to see the difference:\n\n"
       '"Please pick the top wine of 2024 for me."\n\n'
    )
